...
export default function RoundTest() {
  ...
  const handleAutoSubmit = (scenario: "team_wins" | "saboteur_wins" | "tie") => {
    ...
    if (mech === "joke_vote") {
      ...
      players.forEach(p => newSubs.push(makeSubmission(p.id, currentRound.id, mech, { completion: "answer-" + p.id })));
      ...
      <div className="min-h-screen bg-background text-foreground p-8">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-3xl font-display">Test Rounds - {scenarioId}</h1>
          </div>
  ...
  const resultText = result ? (result.is_tie ? "Nichya!" : result.team_scored ? "Komanda pobezhdaet!" : "Sabotazhnik pobezhdaet!") : "";
      ...
      <div className="w-80 border-l border-border bg-background/95 flex flex-col overflow-auto">
        ...
        <div className="p-4 border-b border-border">
          ...
          <div className="grid gap-2">
            ...
            <button onClick={() => handleAutoSubmit("tie")} className="text-sm px-3 py-2 rounded-lg border border-yellow-500/40 text-yellow-500 hover:bg-yellow-500/10 transition-all">Tie/Joke</button>
          </div>
